...
draw db 'X'
input db 0
player_message1 db "first :", 13, 10, "$"  
player_message2 db "second  :", 13, 10, "$" 
...
win_message1 db "********** the first has won !!!!!!! **********", 13, 10, "$"
win_message2 db "********** the second has won !!!!!!! **********", 13, 10, "$"  
type_message db "enter your position broo: $" 
